...
As of 2026-08-05 KST, Visual Studio Marketplace still serves the exact qualified vendor-safe `1.0.53.0` package: 1,914,615 bytes with SHA-256 `E934F24A54F4D4265EA2A758E91A005FB58B84DD7B01CCF56F39F5610DCE8FA3`. Separately, the frozen `2.0.0.0` candidate (1,914,538 bytes, SHA-256 `2A6D94016B03430BDF2EF5ECCF6282D32896C02AEFB3A9EB8F5519AFE4B13512`) passed local package equality and installed-runtime qualification on VS2022 and VS2026. Read [MAINTAINER_HANDOFF.md](MAINTAINER_HANDOFF.md), [release-qualification-2.0.0.md](release-qualification-2.0.0.md), and [release-qualification-1.0.53.md](release-qualification-1.0.53.md) before release work.

Version transition: matching public 1.0.53 product source/evidence commit `7ab84b7` is pushed. The separate 2.0 development line now has a newly versioned and qualified local VSIX; do not confuse it with the public 1.0.53 asset or publish it without the manual/public readback gate.
...
| Work on the vendor-neutral 2.0 buffer contract | [vendor-neutral-buffer-compatibility-matrix.md](vendor-neutral-buffer-compatibility-matrix.md), then [smart-type-mapper-design.md](smart-type-mapper-design.md) and [automatic-vision-inspector.md](automatic-vision-inspector.md) |
