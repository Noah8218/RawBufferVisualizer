...
As of 2026-08-05 KST, the exact vendor-safe local `1.0.53.0` candidate is qualified on VS2022 and stable VS2026. It is 1,914,615 bytes with SHA-256 `E934F24A54F4D4265EA2A758E91A005FB58B84DD7B01CCF56F39F5610DCE8FA3`. Public Marketplace remains exact `1.0.52.0`, 1,902,513 bytes with SHA-256 `3DD78167E60BB7DCC4C3AC1EE83622DEBFF75CEFC2D040977F1D854E33EB9E1F`; do not rebuild or upload another binary under that version. Read [MAINTAINER_HANDOFF.md](MAINTAINER_HANDOFF.md), [release-qualification-1.0.53.md](release-qualification-1.0.53.md), and [post-reinstall-validation-2026-08-03.md](post-reinstall-validation-2026-08-03.md) before release work.

Version transition: matching source/evidence commit `7ab84b7` is pushed. Publish unchanged `1.0.53` as the qualified 1.x stabilization bridge only after explicit Marketplace approval, then start the separate 2.0 development line. Do not relabel the qualified binary as `2.0.0`; a version change creates a different package and requires fresh qualification.
