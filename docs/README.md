...
As of 2026-08-06 KST, Visual Studio Marketplace still serves the exact qualified vendor-safe `1.0.53.0` package: 1,914,615 bytes with SHA-256 `E934F24A54F4D4265EA2A758E91A005FB58B84DD7B01CCF56F39F5610DCE8FA3`. The current unpublished `2.0.0.0` candidate at `D:\OpenVisionLab-TestData\RawBufferVisualizer\release-2.0.0\candidate-connect-doctor-docs-20260806\RawBufferVisualizer-VisualStudioExtensibility-net472\RawBufferVisualizer.VisualStudio.Extensibility.vsix` is 1,923,731 bytes with SHA-256 `D65C8B559A0E5C4A62FCDDEAE345A625DC76F71C4C9FE19BDB0DDE180EDEFC4C`. The same bytes passed the complete consolidated local release matrix, including Break-to-Continue safety, ten legacy library versions, Connect Doctor, and installed regressions on VS2022 and VS2026. The next gate is source commit/push and successful CI; Marketplace upload and public readback still require explicit owner action. Read [MAINTAINER_HANDOFF.md](MAINTAINER_HANDOFF.md), [release-qualification-2.0.0.md](release-qualification-2.0.0.md), and [release-qualification-1.0.53.md](release-qualification-1.0.53.md) before release work.

Version transition: the pre-P0 2.0 source/evidence line is pushed on `origin/main` at `3d88894` (`Release Raw Buffer Visualizer 2.0.0`), and GitHub Actions run [#81](https://github.com/Noah8218/RawBufferVisualizer/actions/runs/30975139392) completed successfully. The current P0 and Connect Doctor follow-ups are an uncommitted worktree change based on that commit. The former frozen 1,914,538-byte candidate remains preserved as historical evidence but is superseded and must not be uploaded because it leaves process-backed rows marked `live` after Continue/process exit. Marketplace publication, commit, push, tag, and public readback remain separate owner-controlled actions.
