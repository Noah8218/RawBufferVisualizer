...
The current review candidate is `2.0.6.0` on the pushed `agent/vs2022-17.9-compat` branch. Official Gallery API readback on 2026-09-03 confirms public `2.0.5.0`, so this candidate advances the immutable package version without changing the validated pointer/name/collection behavior. It keeps the public 2.0.5 hybrid architecture, source-address provenance, complete pointer reads, negative-stride Bitmap correction, and complete image-array registration. The frozen 2.0.6 container passed in-place update and installed runtime checks on VS2022 `17.14.37516.0` and VS2026 `18.8.12105.206`, plus a clean reinstall on VS2022. Exact VS2022 17.9 runtime remains unverified because that host is not installed.

The installed-qualified 2.0.6 VSIX, English Overview, Korean review copy, release notes, and exact installed-2.0.6 media are ready for owner-controlled release review. Source branch push is complete; CI, Marketplace upload, public readback, tag, and GitHub Release remain separate gates. Read [MAINTAINER_HANDOFF.md](MAINTAINER_HANDOFF.md), [release-qualification-2.0.6.md](release-qualification-2.0.6.md), and the historical [release-qualification-2.0.5.md](release-qualification-2.0.5.md) before release work.

Version transition: public `2.0.5.0` remains immutable; `2.0.6.0` is the next stable patch candidate and intentionally contains no new functional contract. The source branch is pushed; CI, Marketplace upload, public readback, tag, and GitHub Release remain separate approval boundaries.
...
| Prepare or publish a Marketplace update | [release-qualification-2.0.6.md](release-qualification-2.0.6.md), [release-runbook.md](release-runbook.md), [marketplace-checklist.md](marketplace-checklist.md), [marketplace-overview-2.0.6.md](marketplace-overview-2.0.6.md), [Korean Overview review copy](marketplace-overview-2.0.6.ko.md), [marketplace-release-notes-2.0.6.md](marketplace-release-notes-2.0.6.md) |
...
| Check the owner-controlled 2.0.6 Marketplace package and copy | [release-qualification-2.0.6.md](release-qualification-2.0.6.md), [marketplace-overview-2.0.6.md](marketplace-overview-2.0.6.md), [Korean Overview review copy](marketplace-overview-2.0.6.ko.md), and [marketplace-release-notes-2.0.6.md](marketplace-release-notes-2.0.6.md) |
