...
```powershell
powershell -ExecutionPolicy Bypass -File C:\Git\RawBufferVisualizer\scripts\Bump-VisualStudioExtensionVersion.ps1 -Version 1.0.42
```
...
```xml
<AssemblyVersion>1.0.42.0</AssemblyVersion>
<FileVersion>1.0.42.0</FileVersion>
<Version>1.0.42</Version>
```

```xml
<Identity Id="RawBufferVisualizer.34f8ad30-2f11-4c37-a9d4-00f3a8c1d29f" Version="1.0.42.0" Language="en-US" Publisher="Noah Choi" />
```
...
| `categories` | `other` |
| `expected_version` | Exact VSIX version, for example `1.0.42.0`. |
...
```powershell
powershell -ExecutionPolicy Bypass -File C:\Git\RawBufferVisualizer\scripts\Test-VisualStudioMarketplaceUpdate.ps1 -ExpectedVersion 1.0.42.0
```
