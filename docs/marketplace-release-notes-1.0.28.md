...
- Retains legacy OpenCvSharp `Mat` support introduced in 1.0.27. Real `Mat` transfers were validated with OpenCvSharp4 4.0.0, 4.2.0, 4.5.5, 4.8.0, and 4.13.0 package lines.
- Retains existing .NET Framework `System.Drawing.Bitmap` support.
