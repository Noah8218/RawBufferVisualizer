...
namespace RawBufferVisualizer.Tests
{
    internal static class ReleaseAnnouncementTests
    {
        ...
        private static void CurrentUnseenReleaseIsShown()
        {
            ...
            Assert(
                !ReleaseAnnouncementCatalog.ShouldShow("1.0.53.0", "1.0.53"),
        ...
        {
            Assert(
                !ReleaseAnnouncementCatalog.ShouldShow("1.0.52.0", string.Empty),
                "An older installed extension must not show a future announcement.");
            Assert(
                !ReleaseAnnouncementCatalog.ShouldShow("1.0.54.0", string.Empty),
        ...
        private static void DismissedVersionSurvivesStoreRecreation()
        {
            ...
            try
            {
                ...
                Assert(
                    !ReleaseAnnouncementCatalog.ShouldShow("1.0.53.0", restarted.LastSeenVersion),
